...
public class Pedido {
    ...
    public String toString() {
        return "Pedido{" + "cpf=" + cpf + ", xsalada=" + xsalada + ", xburger=" + xburger + ", cachorroquente=" + cachorroquente + ", mistoquente=" + mistoquente + ", saladadefrutas=" + saladadefrutas + ", refrigerante=" + refrigerante + ", suconatural=" + suconatural + '}';
    }
